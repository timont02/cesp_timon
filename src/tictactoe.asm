...
bot_rule_3:
	...
	corner_counter_2:
		addi s3, s3, 1 # counter for corner fields, taken by player 1
		beq a4, t3, corner_counter_3 # is field 3 taken by player 1?
		beq a4, a1, corner_counter_4 # is field 7 taken by player 1?
		la s4, bot_rule_3
		jalr zero, 40(s4)
	
	corner_counter_3:
		addi s3, s3, 1 # counter for corner fields, taken by player 1
		beq a4, t3, corner_counter_4 # is field 3 taken by player 1?
		la s4, bot_rule_3
		jalr zero, 40(s4)
